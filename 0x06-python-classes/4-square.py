#!/usr/bin/python3
"""Square generation_module for Python_project 0x06
"""


class Square:
    """Class defined for square_generation.
    ...
    def area(self):
        """Calulating area of square.

        Attributes:
            __size (int): length of 1 side of square

        Returns:
            area (int): length of 1 side, squared
