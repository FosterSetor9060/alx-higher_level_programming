(Python OOP) # 0x08. Python - More Classes and Objects
...
Provide instructions on how to install the project. Include any dependencies that need to be installed and steps for setting up the environment.
